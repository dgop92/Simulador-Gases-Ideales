...
public class PVGraph extends SketchFragment implements GasObserver {
    ...
    public PVGraph(SimulationWorkspace sketch, float x, float y, float fragmentWidth, float fragmentHeight) {
        ...
        gasPVRange = new GasPVRange(GasDataMap.MIN_USER_PRESSURE, GasDataMap.MAX_USER_PRESSURE,
    ...
    private void drawAxes() {
        ...
        sketch.text("P", x + XY_BORDER_GAP - 4, y + XY_BORDER_GAP - 10);

        sketch.line(x + XY_BORDER_GAP, y + XY_BORDER_GAP, x + XY_BORDER_GAP, y + fragmentHeight - XY_BORDER_GAP);

        sketch.text("V", x + fragmentWidth - XY_BORDER_GAP + 10, y + fragmentHeight - XY_BORDER_GAP + 5);

        sketch.line(x + XY_BORDER_GAP, y + fragmentHeight - XY_BORDER_GAP, x + fragmentWidth - XY_BORDER_GAP,
    ...
    private void drawGrid() {
        ...
        for (int i = 1; i <= Y_LINES; i++) {
            ...
            sketch.text((int) (gasPVRange.minVolume + (i - 1) * xScaleFactor), startX + (i - 1) * XY_GRID_GAP,
                    y + fragmentHeight - XY_BORDER_GAP + 10);
            sketch.line(startX + i * XY_GRID_GAP, y + XY_BORDER_GAP, startX + i * XY_GRID_GAP,
                    y + fragmentHeight - XY_BORDER_GAP);
        ...
        for (int i = 0; i < X_LINES; i++) {
            ...
            sketch.text((int) (gasPVRange.minPressure + i * yScaleFactor), x + 2, startY - i * XY_GRID_GAP);

            sketch.line(x + XY_BORDER_GAP, startY - i * XY_GRID_GAP, x + fragmentWidth - XY_BORDER_GAP,
    ...
    public void updateGasData(GasData gasData) {
        ...
        float p = gasData.getGasData().get("pressure");
        float v = gasData.getGasData().get("volume");
        ...
        points.add(new PVector(x + XY_BORDER_GAP + xPoint, y + fragmentHeight - XY_BORDER_GAP - yPoint));
    }
}