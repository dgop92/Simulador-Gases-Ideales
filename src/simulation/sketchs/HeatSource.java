...
public class HeatSource extends SketchFragment implements GasObserver {
    ...
    public HeatSource(SimulationWorkspace sketch, float x, float y, float fragmentWidth, float fragmentHeight) {
    ...
    public void updateGasData(GasData gasData) {
        this.isLosingHeat = gasData.isLosingHeat();
        this.isAbsorbingHeat = gasData.isAbsorbingHeat();
    }
